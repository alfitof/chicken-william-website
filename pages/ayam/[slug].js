...
export default function Ayam({ ayam }) {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col gap-0 md:gap-20 pt-5 justify-center items-center md:flex-row md:items-start space-y-8 md:space-y-0 md:space-x-4 lg:space-x-8 max-w-6xl w-11/12 mx-auto">
        <div className={css.imageWrapper}>
          <Image
            src={src}
            loader={() => src}
